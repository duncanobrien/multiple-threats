...
```{r figShaversine, fig.height=4, fig.width=6, messages = FALSE,fig.cap="Influence of rounding latitude to the nearest degree upon the estimated distance between Living Planet Databse sites"}
dd_long2 <- dd_long %>%
  group_by(ID) %>%  
